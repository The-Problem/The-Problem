...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2015 at 02:37 PM
...
('Andrew', 'fireme@mailinator.net', 'Andrew', '$2y$10$o0bQZMYLGzVNqexQ9X5mTeGVTFLEtmdg2cRiyyWtlOzeAgGk6tUlm', 0, '', NULL),
('bullseye', 'bullseye@mailinator.net', 'Mr T', '$2y$10$/WfS9BksZkg7ca3CCVTIsOGapLHFp1NH/HRKpITBqp.MPKkO/0ZXW', 0, '', NULL),
...
('exterminate', 'david@mailinator.net', 'David', '$2y$10$GRuSi8B2e3pG2RcuQ9TemuwaUBa.qzepKjgAJjcmMLa8DDpgRtOTe', 0, '', NULL),
('flame', 'flame@mailinator.net', 'Andria', '$2y$10$8.xBNUavPm7.hD3iG6QkxuNithxCGTMcgpUWIIuVRvrtVsbFAcWsO', 0, '', NULL),
...
('hackers', 'davee3@mailinator.net', 'Dave', '$2y$10$UDb3Zn8D0yjl2zo5p2AHJeG54z8XzbGy3fi3lYGQkO065cfpkQ8tm', 0, '', '2015-08-26 21:23:20'),
('Jas', 'jjj@mailinator.net', 'Jas', '$2y$10$iZ2eKISWEvIQ7xyTElt.Terl.w9AvZSdFg4Ui3UZ/TLfFt4uh5k1a', 0, '', NULL),
('jackass', 'jackass@mailinator.net', 'Jake Peearaa', '$2y$10$Doo6SZyzZmrxdKPBpJYYaeNk0fhiIGcXvR.9lJcU9Pmd4Y5WGSQKq', 0, '', NULL),
('KaiXinGuo', 'kai@mailinator.net', 'Kai', '$2y$10$cA9eTBMpI5yZqkVJMMrrgubMMfdeNATCpV4DCziDNowlHdCTs9nfG', 0, '', NULL),
('KatieLilly', 'jrn@mailinator.net', 'Katie Lilly', '$2y$10$NXiQVXX/ABzC/UXdR/YWMOjlqOO7HwJ2.oifS1GdC8Ial9RtqjyxS', 0, '', NULL),
('Liam', 'LIAM@mailinator.net', 'Liam Prok', '$2y$10$.rnGQiCFaato0Km1.HJ5wenLgu/C5F.3hz/4mSvK33xWUsM3TCymK', 1, '', '2015-08-26 21:09:09'),
('MichaelK', 'mike@mailinator.net', 'Michael', '$2y$10$vT7TaMeRGk6oomeNsB3AWOPB/f7lA9YsAWPtfxcoljF1OTOmqOB3y', 0, '', NULL),
('madEagle', 'knights@mailinator.net', 'KnightsOfTheRoundTable', '$2y$10$Qgi2LRFQut0WV90Qz4omWe79Kh6ZUlmSxY.zB7/aFrvX1q8qfbxha', 0, 'Introducing I, knightsOfTheRoundTable, the first user on The Problem to take advantage of hashed password security!!.', '2015-08-28 21:26:50'),
('meltingPoint', 'mp@mailinator.net', 'Jess', '$2y$10$N87Mlr4M/ITnZYEO7WOk.ePLQlaSHAMNbX.8mtBLLc42ehkWGaH5W', 0, '', NULL),
...
('No.', 'nonono@no.com.au', 'No.', '$2y$10$pjEvx04jAMTHFLVd59WwD./ONCOJfLY.i.B2D.EhhoonLnAMa4why', 0, '', '2015-08-28 19:51:43'),
('powerRangers46', 'pewpew@mailinator.net', 'Zac Langlands', '$2y$10$HZ8d0bep.Vie7VyAmsk9i.yy.DEFN8cIUQqUcJXpFE28iKN0QUfqe', 0, '', NULL),
('SmithJohn', 'jsjs@mailinator.net', 'John Smith', '$2y$10$yA0PIxwKiSbrrLom7outhemOtfu9ksmqUQ/oWnYV/oP6zfKq6712O', 0, 'There''s probably not a single person in this development team that''s as skilled as I am in making tea.', NULL),
('that''sMe', 'hu@mailinator.net', 'DoctorHu', '$2y$10$aetQkTLivZd1/ZnlX2ah8e3AvFHJzpQ3U.tXCPc18LC4b.HBSdKji', 0, '', NULL),
('unhelpful', 'unhelpful@mailinator.net', 'Ben Loungin', '$2y$10$lxONG2iNdaphSGdE77G.Ee9hhhbFHUr7GI5cd55mWXRJU0y8LtKaa', 0, '', NULL);
...
--
ALTER TABLE `objects`
  MODIFY `Object_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=32;
--
