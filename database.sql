...
--
-- Host: localhost
-- Generation Time: Aug 24, 2015 at 01:59 PM
...
INSERT INTO `comments` (`Comment_ID`, `Bug_ID`, `Username`, `Object_ID`, `Creation_Date`, `Edit_Date`, `Comment_Text`) VALUES
  ...
  (6, 45, 'mrfishie', 35, '2015-08-23 17:56:24', '2015-08-23 17:56:27', 'That is.. a `very good` question.\nTry pasting _this_ in **your browsers URL bar!**\n```\njavascript:while(true)alert(''I dont know what Im doing");\n```'),
